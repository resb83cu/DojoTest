define([
	...
	// the id==dijit._scopeName + "._editor.RichText.value" (typically "dijit/_editor/RichText.value). For web,
	...
	var RichText = declare("dijit._editor.RichText", [_Widget, _CssStateMixin], {
		...
		_localizeEditorCommands: function(){
			...
			//		so that we have to say (for web) danraku instead of p (for paragraph).
			//		Handle that here.
			// tags:
			//		private
