define([
	...
	var _TextBoxMixin = declare("dijit.form._TextBoxMixin" + (has("dojo-bidi") ? "_NoBidi" : ""), null, {
		...
		_setValueAttr: function(value, /*Boolean?*/ priorityChange, /*String?*/ formattedValue){
			...
			if(value !== undefined){
				...
				if(typeof formattedValue != "string"){
					...
					// web, dijit/form/FilteringSelect determines the formatted value asynchronously and applies it using a
		...
		_setDisplayedValueAttr: function(/*String*/ value){
			...
			// (if possible), and also updates the textbox.value, for web converting "123"
			// to "123.00"
		...
		_setBlurValue: function(){
			// Format the displayed value, for web (for NumberTextBox) convert 1.4 to 1.400,
