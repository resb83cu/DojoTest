define([
	...
	var NumberTextBoxMixin = declare("dijit.form.NumberTextBoxMixin", null, {
		...
		_formatter: function(value, options){
			...
			//		as a string, for web converting 12345 into "12,345".
			// value: Number
		...
		_isValidSubset: function(){
			...
			//
			// For web, if an input has a maxLength of 5, and a min value of greater than 100, then the subset
			// is invalid if there are 3 leading 0s. It remains valid for the first two.
			//
			// Another web is if the min value is 1.1. Once a value of 1.0 is entered, no additional trailing digits
