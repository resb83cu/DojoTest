...
dojox.storage.manager = new function(){
	...
	this.autodetect = function(){
		...
		// than dojox.storage.currentProvider.put, for web
	...
	this.getResourceList = function(){
		...
		//		this particular environment type. For web, if we are in the
		...
		//		mechanisms hits the local offline cache. For web, if we
