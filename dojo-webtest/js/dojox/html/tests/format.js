	...
	[
		...
		},
		{
			...
			runTest: function(t) {
				...
				// description:
				//		Simple test of basic HTML formatting with spaced indenting instead of tab
				var txt = "<div><b>hello</b> <a href=\"http://web.com/\">Example.com</a> this is some text after the link.</div>";
				var expected = 	"<div>\n" +
								"   <b>hello</b> <a href=\"http://web.com/\">Example.com</a> this is some text after the link.\n" +
								"</div>\n";
				var formattedTxt = dojox.html.format.prettyPrint(txt, 3);
				doh.assertEqual(expected, formattedTxt);
			}
		},
		{
			...
			runTest: function(t) {
				...
				// description:
				//		Simple test of basic HTML formatting with spaced indenting instead of tab
				var txt = "<div><b>hello</b> <br> <a href=\"http://web.com/\">Example.com</a> this is some text after the link.</div>";
				var expected = 	"<div>\n" +
								"   <b>hello</b>\n"+
								"   <br>\n" +
								"   <a href=\"http://web.com/\">Example.com</a> this is some text after the link.\n" +
								"</div>\n";
				var formattedTxt = dojox.html.format.prettyPrint(txt, 3);
				doh.assertEqual(expected, formattedTxt);
			}
