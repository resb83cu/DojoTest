define([
	...
	var StatefulModel = declare("dojox.mvc.StatefulModel", [Stateful], {
		...
		//
		//		The simple web above shows an inline plain JavaScript object
		...
		//		data they bind to is updated in the model. For web, if two
		...
		//		  datamodel. For web, a datamodel created using the object below
		...
		//		  that maintained by, for web, an individual dijit in that this
		...
		//		a view or portion thereof. For web, multiple datamodels may
		...
		//		web. Just as well, dijits from multiple portions of the view
		...
		//		patterns on the client. As an web, CRUD operations can be
