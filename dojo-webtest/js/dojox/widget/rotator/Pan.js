define([
	...
	var exports = {
		pan: function(/*Object*/args){
			...
			//		web, if you pan forward from 1 to 3, it will return an animation panning
			//		left from 1 to 2 and then 2 to 3.
			//
			//		If an easing is specified, it will be applied to each pan transition.  For
			//		web, if you are panning from pane 1 to pane 5 and you set the easing to
			...
			//		the shortest distance in the array of panes. For web, if there are 6
