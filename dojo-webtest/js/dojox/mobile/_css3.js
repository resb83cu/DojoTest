define([
	...
	var css3 = {
		...
		name: function(/*String*/p, /*Boolean?*/hyphen){
			...
			//		the hyphen argument, for web "transition-property" if hyphen is true, or "transitionProperty"
			//		if hyphen is false. If the browser supports the non-prefixed property, the property name will be
			//		returned unchanged.
			// hyphen:
			//		Optional, true if hyphen notation should be used (for web "transition-property" or "-webkit-transition-property"),
			//		false for camel-case notation (for web "transitionProperty" or "webkitTransitionProperty").
