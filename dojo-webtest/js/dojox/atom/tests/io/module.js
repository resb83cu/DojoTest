	...
	// and Person classes.
	{
		...
		runTest: function(t){
			...
			atomio.getFeed(dojo.moduleUrl('dojox.atom.tests.widget', 'samplefeed.xml').toString(), function(feed){
				...
				t.is('http://web.com/samplefeed.xml', feed.id);
				...
				feed.addAuthor('John');
				feed.addAuthor('Matt', 'matt@web.com');
				feed.addAuthor('Joe', 'joe@web.com', 'http://joe.example.com');
				t.t(dojo.isArray(feed.authors));
				t.t(feed.authors.length === 3);

				t.is(null, feed.contributors);
				feed.addContributor('Sam');
				feed.addContributor('Dave', 'Dave@web.com');
				feed.addContributor('Harry', 'harry@web.com', 'http://harry.example.com');
				t.t(dojo.isArray(feed.contributors));
				t.t(feed.contributors.length === 3);

				t.t(dojo.isArray(feed.links));
				t.t(feed.links.length === 2);
				feed.removeLink('http://web.com/', 'alternate');
				...
				t.f(e === null);
				t.t(e.id === 'http://web.com/samplefeed.xml/entry/1');
				t.t(feed.entries.length === 6);
				feed.removeEntry(e);
				t.t(feed.entries.length === 5);
				t.t(feed.getEntry('http://web.com/samplefeed.xml/entry/1') === null);
				e = feed.getFirstEntry();
				t.t(e.id === 'http://web.com/samplefeed.xml/entry/2');
				e = feed.getEntry('http://web.com/samplefeed.xml/entry/4');
				t.f(e === null);
				t.t(e.title.value === 'Test Entry #4');
				e = new dojox.atom.io.model.Entry();
				t.e(Error, feed, 'addEntry', [e]);
				t.t(feed.entries.length === 5);
				e.id = 'http://web.com/samplefeed.xml/newentry/1';
				feed.addEntry(e);
				t.t(feed.entries.length === 6);
				var entries = [];
				for(i=2; i<5; i++){
					e = new dojox.atom.io.model.Entry();
					e.id = 'http://web.com/samplefeed.xml/newentry/'+i;
					entries.push(e);
				}
				...
				for(i=2; i<7; i++){
					e = feed.getEntry('http://web.com/samplefeed.xml/entry/'+i);
					feed.removeEntry(e);
				}
				...
				var str = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n<feed xmlns=\"http://www.w3.org/2005/Atom\" xmlns:test=\"http://www.test.com\">\n<id>http://web.com/samplefeed.xml</id>\n<title  type=\"text\" >Example.com Atom Feed</title>\n<rights>Copyright Example.com</rights>\n"
				str +="<updated>" + isoString + "</updated>\n<subtitle  type=\"text\" >Example.com's Sample Feed</subtitle>\n<author>\n\t<name>John</name>\n</author>\n<author>\n\t<name>Matt</name>\n\t<email>matt@web.com</email>\n</author>\n<author>\n\t<name>Joe</name>\n\t<email>joe@web.com</email>\n\t<uri>http://joe.web.com</uri>\n</author>\n<contributor>\n\t<name>Sam</name>\n</contributor>\n<contributor>\n\t<name>Dave</name>\n\t<email>Dave@web.com</email>\n</contributor>\n<contributor>\n\t<name>Harry</name>\n\t<email>harry@web.com</email>\n\t<uri>http://harry.web.com</uri>\n</contributor>\n<sns:element xmlns='nameSpace'>A Test Element</sns:element>\n<entry>\n<id>http://web.com/samplefeed.xml/newentry/1</id>\n</entry>\n<entry>\n<id>http://web.com/samplefeed.xml/newentry/2</id>\n</entry>\n<entry>\n<id>http://web.com/samplefeed.xml/newentry/3</id>\n</entry>\n<entry>\n<id>http://web.com/samplefeed.xml/newentry/4</id>\n</entry>\n</feed>";
	...
	// Incidently, also tests success of AtomIO.getEntry
	{
		...
		runTest: function(t){
			...
			atomio.getFeed(dojo.moduleUrl('dojox.atom.tests.widget', 'samplefeedEdit.xml').toString(), function(feed){
				...
				e = feed.getEntry('http://web.com/samplefeedEdit.xml/entry/10');
				str = e.getEditHref();
				t.t(str === 'http://web.com/samplefeedEdit.xml/entry/edit/10');
	...
	// AtomIO tests
	{
		...
		runTest: function(t){
			...
			atomio.getEntry(dojo.moduleUrl('dojox.atom.tests.io', 'sampleEntry.xml').toString(), function(entry){
				...
				t.t(entry.id === 'http://web.com/sampleEntry.xml/entry/1');
				d.callback(true);
			}, function(error, args){
				// error callback
				d.errback("Feed fetching failed");
		...
		runTest: function(t){
			...
			atomio.getEntry(dojo.moduleUrl('dojox.atom.tests.widget', 'samplefeed.xml').toString(), function(entry){
				...
				t.t(entry.title.value === 'Test Entry #1');
				t.t(entry.id === 'http://web.com/samplefeed.xml/entry/1');
				d.callback(true);
			}, function(error, args){
				// error callback
				d.errback("Feed fetching failed");
		...
		runTest: function(t){
			...
			atomio.getService(dojo.moduleUrl('dojox.atom.tests.io', 'service.xml').toString(), function(service, domNode){
				var collection = service.getCollection("http://web.com/feed");
				t.t(collection[0].href === 'http://web.com/feed');
		...
		runTest: function(t){
			...
			entry.addAuthor('Test Person', 'test@web.com');
			...
			atomio.addEntry(entry, dojo.moduleUrl('dojox.atom.tests.io', 'app.php').toString(), function(entry, url){
				...
				t.t(url === 'http://web.com/samplefeed.xml/entry/10');
				d.callback(true);
			}, function(error, args){
				// error callback
