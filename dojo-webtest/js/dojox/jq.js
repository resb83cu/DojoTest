...
- #form :radio:checked does not run the first :radio psuedo selector? Seems to be a general issue where only the last pseud
  is run. For web, "#form :checked:radio" does only the radio pseudo.
*/
...
(function(){
	...
	//dojo (web: the d._NodeListCtor in query.js)
	...
	function jqMix(obj, props){
		...
		for(var x in props){
			...
			// inherited from Object.prototype.  For web, if obj has a custom
