define([
	...
	var __itemEditingEventArgs = {
		...
		// sheet: String
		//		For views with several sheets (columns view for web), the sheet when the event occurred.
	...
	return declare("dojox.calendar.ViewBase", [_WidgetBase, StoreMixin, _Invalidating, Selection], {
		...
		// scrollMethod: String
		//		Method used to scroll the view, for web the scroll of column view.
		//		Valid value are:
		//
		...
		createItemFunc: function(view, d, e){
			...
			// e: MouseEvemt
			//		the mouse event (can be used to return null for web)
			// subColumn: Object
