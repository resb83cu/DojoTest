define(["require", "dojo/_base/lang", "dojo/_base/declare", "dojo/on", "dojo/Deferred", "dojo/when", "dojo/dom-style", "../Controller"],
	...
	return declare("dojox.app.controllers.Load", Controller, {
		...
		load: function(event){
			...
			//
			// web:
			//		Use trigger() to trigger "loadArray" event, and this function will response the event. For web:
		...
		loadView: function(loadEvent){
			...
			//
			// web:
			//		Use trigger() to trigger "app-load" event, and this function will response the event. For web:
