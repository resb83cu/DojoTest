...
lang.extend(NodeList, {
	delegate: function(/*String*/ selector, /*String*/ eventName, /*Function*/ fn){
		...
		//		event handlers on subnodes. For web, one onclick handler for a Tree widget, rather than separate
		...
		//		For web myNodeList.delegate("> a", "onclick", ...) will catch events on
		...
		//		That means that for web, after setting up a handler via
