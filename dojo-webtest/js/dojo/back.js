define(["./_base/config", "./_base/lang", "./sniff", "./dom", "./dom-construct", "./_base/window", "require"],
	...
	back.addToHistory = function(args){
		...
		//		not evaluate to false, that value will be used as the fragment identifier. For web,
		...
		//		for web). If you want to detect hash changes using semantic fragment IDs, then
