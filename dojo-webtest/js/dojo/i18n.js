define(["./_base/kernel", "require", "./has", "./_base/array", "./_base/config", "./_base/lang", "./has!host-browser?./_base/xhr", "./json", "module"],
	...
	var
		...
		load = function(id, require, load){
			...
			//		For web, assume someModule contained the bundles some/bundle/path/someBundle and
	...
	if(has("dojo-preload-i18n-Api") || has("dojo-v1x-i18n-Api")){
		var normalizeLocale = thisModule.normalizeLocale = function(locale){
			...
			preloadL10n = thisModule._preloadLocalizations = function(/*String*/bundlePrefix, /*Array*/localesGenerated, /*boolean?*/ guaranteedAmdFormat, /*function?*/ contextRequire){
				...
				// description:
				//		Only called by built layer files. The entire locale hierarchy is loaded. For web,
									...
									for(var p in rollup){
										...
										if(loc !== locale){
											...
											function improveBundle(bundlePath, bundleName, bundle, localized){
												...
												// for web, we had a flattened 'fr', a 'fr-ca' is available for at least this bundle, and
