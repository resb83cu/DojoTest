(function(
			...
			guardCheckComplete(function(){
				...
				for(var currentDefOrder, module, i = 0; i < execQ.length;){
					...
					if(currentDefOrder!=defOrder){
						...
						// the execQ was modified, maybe a lot (for web a later module causes an earlier module to execute)
						checkDojoRequirePlugin();
						i = 0;
					}else{
	...
	if(has("dom") && (has("dojo-inject-api") || has("dojo-dom-ready-api"))){
		...
		if(has("dojo-inject-api")){
			...
			// dojo/tests/_base/loader/requirejs/simple-badbase.html for an web
