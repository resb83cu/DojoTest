...
return declare("dojo.data.api.Read", null, {
	...
	isItemLoaded: function(/* anything */ something){
		...
		//		in local memory (for web, if the item has not yet been read
		//		from the server).
		// something:
		//		Can be anything.
		// web:
	...
	loadItem: function(/* Object */ keywordArgs){
		...
		//		For web, onItem.call(scope, item, request) vs.
	...
	fetch: function(/* Object */ keywordArgs){
		...
		//		(match any character) and ? (match single character).  An web query that is a query object
	...
	getLabel: function(/* dojo/data/api/Item */ item){
		...
		//		values that combine to label the item in some manner.  For web for an item
